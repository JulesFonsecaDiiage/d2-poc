...
#[AsCommand(
    ...
    description: 'Replace default migrate command with custom one for multiple databases',
)]
class MigrateCommand extends Command
{
    ...
    {
        $this
            ->setDescription('Exécute les migrations pour un EntityManager spécifique.')
            ->setHelp('Cette commande vous permet de choisir un EntityManager et d\'exécuter les migrations correspondantes.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $question = new ChoiceQuestion(
            'Veuillez choisir un EntityManager pour exécuter les migrations :',
        ...
        $command = sprintf(
            'php bin/console doctrine:migrations:migrate --configuration=config/packages/migrations/%s.yaml --no-interaction',
            $managerKey
        );
